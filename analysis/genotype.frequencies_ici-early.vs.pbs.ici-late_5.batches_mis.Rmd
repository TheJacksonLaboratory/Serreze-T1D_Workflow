---
title: "Genotype Frequencies - ICI-Early vs PBS & ICI-Late "
...
##extracting animals with ici (early & late) and pbs group status
...
## saving files
#write.csv(filtered_gf_mar_geno_sample, "data/ici-early.vs.pbs.ici-late_sample.genos_marker.freq_low.geno.freq.removed.csv", quote=F)
#write.csv(filtered_gf_mar_probs_sample, "data/ici-early.vs.pbs.ici-late_sample.genos_marker.freq_low.probs.freq.removed.csv", quote=F)

write.csv(filtered_gf_mar_geno, "data/ici-early.vs.pbs.ici-late_marker.freq_low.geno.freq.removed_geno.ratio_5.batches_mis.csv", quote=F)
write.csv(filtered_gf_mar_probs, "data/ici-early.vs.pbs.ici-late_marker.freq_low.probs.freq.removed_geno.ratio_5.batches_mis.csv", quote=F)
...
## saving files
#write.csv(filtered_gf_mar_geno_sample, "data/ici-early.vs.pbs.ici-late_sample.genos_marker.freq_low.geno.freq.removed_sample.outliers.removed.csv", quote=F)
#write.csv(filtered_gf_mar_probs_sample, "data/ici-early.vs.pbs.ici-late_sample.genos_marker.freq_low.probs.freq.removed_sample.outliers.removed.csv", quote=F)

write.csv(filtered_gf_mar_geno, "data/ici-early.vs.pbs.ici-late_marker.freq_low.geno.freq.removed_sample.outliers.removed_geno.ratiov_5.batches_mis.csv", quote=F)
write.csv(filtered_gf_mar_probs, "data/ici-early.vs.pbs.ici-late_marker.freq_low.probs.freq.removed_sample.outliers.removed_geno.ratio_5.batches_mis.csv", quote=F)
