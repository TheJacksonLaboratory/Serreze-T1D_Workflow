...
* Step 2: [SNP QC](2.2.1_snp_qc_5.batches.html)(removing monomorphic, gnotype Error & missing markers)
...
### **3. Phenotype QC**
* No QC as using binary phenotypes for best results


### **4. QTL Analysis**
* binary phenotpe (removed additional low frequency markers as well as disproportionate markers (identified in Step 2.4) within each sample set)
  + [ICI vs EOI](4.1.1_qtl.analysis_binary_ici.vs.eoi_snpsqc_dis_no-x_updated_5.batches.html)
  + [ICI vs PBS](4.1.1_qtl.analysis_binary_ici.vs.pbs_snpsqc_dis_no-x_updated_5.batches.html)
