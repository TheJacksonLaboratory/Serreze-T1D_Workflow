...
# Plot 2
  ...
  write.csv(as.data.frame(blup_sub), paste0("data/ici.vs.eoi_blup_sub_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_5.batches.csv"), quote=F)
 ...
 # Plot 3
  ...
  write.csv(genesgss, file=paste0("data/ici.vs.eoi_genes_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_5.batches.csv"), quote=F)
...
#  write.csv(as.data.frame(blup), paste0("data/ici.vs.eoi_blup.qc_chr-",chr,"_5.batches.csv"), quote=F)
#}
...
#  write.csv(as.data.frame(blup), paste0("data/ici.vs.eoi_blup.full_chr-",chr,"_5.batches.csv"), quote=F)
#}

#save(out, operm, gm.full, gm, pr.qc, pr.full, file="data/ici.vs.eoi_scanone_5.batches.Rdata")
...
write.csv(qtl.d3,"data/ici.vs.eoi_gm_qtl_5.batches.csv", quote=F, row.names=F)
...
cross <- qtl::read.cross("csv", file = "data/ici.vs.eoi_gm_qtl_5.batches.csv",alleles=c("A","B"))
