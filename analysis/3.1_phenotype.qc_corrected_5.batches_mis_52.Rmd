---
title: "Phenotype QC [Continious (corrected) Phenotype - Age of Onset]"
...
gm$covar[is.na(gm$covar$age.of.onset),]$age.of.onset = 52
...
write.csv(gm$covar,"data/covar_corrected_ici.vs.eoi_5.batches_mis_52.csv", row.names=F, quote=F)
...
write.csv(gm$covar,"data/covar_corrected.cleaned_ici.vs.eoi_5.batches_mis_52.csv", row.names=F, quote=F)
...
##removing outliers
gm$covar$Mouse.ID <- rownames(gm$covar)
write.csv(gm$covar,"data/covar_corrected_ici.vs.pbs_5.batches_mis_52.csv", row.names=F, quote=F)
...
#gm$covar <- gm$covar[c(1:15)]
#gm$covar$id <- rownames(gm$covar)
write.csv(gm$covar,"data/covar_corrected.cleaned_ici.vs.pbs_5.batches_mis_52.csv", row.names=F, quote=F)
...
phenos.covars.lg <- gm$covar %>% gather(variable, value, -c("id","group","sex","diabetic status","strain","ICI_Early.vs.PBS"))
...
phenos.covars.lg <- gm$covar %>% gather(variable, value, -c("id","group","sex","diabetic status","strain","ICI_Early.vs.PBS","age.of.onset"))
...
##removing outliers
gm$covar$Mouse.ID <- rownames(gm$covar)
write.csv(gm$covar,"data/covar_corrected_ici-early.vs.pbs_5.batches_mis_52.csv", row.names=F, quote=F)
...
#gm$covar <- gm$covar[c(1:15)]
#gm$covar$id <- rownames(gm$covar)
write.csv(gm$covar,"data/covar_corrected.cleaned_ici-early.vs.pbs_5.batches_mis_52.csv", row.names=F, quote=F)
