...
phenos.covars.lg <- gm$covar %>% gather(variable, value, -c("id","group","group.new", "sex","diabetic status","strain","ICI.Early.vs.PBS_ICI.Late"))

box1 <-  ggplot(data=phenos.covars.lg, aes(x=variable, y=as.numeric(value), color=group.new, fill=group.new)) +
...
phenos.covars.lg <- gm$covar %>% gather(variable, value, -c("id","group","group.new","sex","diabetic status","strain","ICI.Early.vs.PBS_ICI.Late","age.of.onset"))
...
write.csv(gm$covar,"data/covar_corrected_ici-early.vs.pbs.ici-late_5.batches_mis.csv", row.names=F, quote=F)
...
write.csv(gm$covar,"data/covar_corrected.cleaned_ici-early.vs.pbs.ici-late_5.batches_mis.csv", row.names=F, quote=F)
