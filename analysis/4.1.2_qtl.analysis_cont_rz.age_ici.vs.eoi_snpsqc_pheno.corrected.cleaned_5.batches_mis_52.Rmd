...
# Plot 2
  ...
  write.csv(as.data.frame(blup_sub), paste0("data/ici.vs.eoi_",peaks$phenotype[i],"-no.covariates_blup_sub_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_snpsqc_5.batches_mis_52.csv"), quote=F)
 ...
 # Plot 3
  ...
  write.csv(genesgss, file=paste0("data/ici.vs.eoi_",peaks$phenotype[i],"-no.covariates_genes_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_snpsqc_5.batches_mis_52.csv"), quote=F)
...
# Plot 2
  ...
  write.csv(as.data.frame(blup_sub), paste0("data/ici.vs.eoi_",peaks$phenotype[i],"-additive.covariates_blup_sub_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_snpsqc_5.batches_mis_52.csv"), quote=F)
 ...
 # Plot 3
  ...
  write.csv(genesgss, file=paste0("data/ici.vs.eoi_",peaks$phenotype[i],"-additive.covariates_genes_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_snpsqc_5.batches_mis_52.csv"), quote=F)
...
# Plot 2
  ...
  write.csv(as.data.frame(blup_sub), paste0("data/ici.vs.eoi_",peaks$phenotype[i],"-interactive.covariate_blup_sub_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_snpsqc_5.batches_mis_52.csv"), quote=F)
 ...
 # Plot 3
  ...
  write.csv(genesgss, file=paste0("data/ici.vs.eoi_",peaks$phenotype[i],"-interactive.covariate_genes_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_snpsqc_5.batches_mis_52.csv"), quote=F)
