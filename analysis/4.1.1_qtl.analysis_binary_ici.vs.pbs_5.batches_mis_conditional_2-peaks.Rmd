...
#  write.csv(as.data.frame(blup), paste0("data/ici.vs.pbs_blup.qc_chr-",chr,"_5.batches_mis_conditional_2-peaks-chr3-4.csv"), quote=F)
#}
...
#  write.csv(as.data.frame(blup), paste0("data/ici.vs.pbs_blup.full_chr-",chr,"_5.batches_mis_conditional_2-peaks-chr3-4.csv"), quote=F)
#}

#save(out, operm, gm.full, gm, pr.qc, pr.full, file="data/ici.vs.pbs_scanone_5.batches_mis_conditional_2-peaks-chr3-4.Rdata")
...
write.csv(qtl.d3,"data/ici.vs.pbs_gm_qtl_5.batches_mis_conditional_2-peaks-chr3-4.csv", quote=F, row.names=F)
...
#  chr = i
#  blup <- scan1blup(pr.qc[,chr], gm$covar["ICI.vs.PBS"])
#  write.csv(as.data.frame(blup), paste0("data/ici.vs.pbs_blup.qc_chr-",chr,"_5.batches_mis_conditional_2-peaks-chr3-10.csv"), quote=F)
#}
...
#  chr = i
#  blup <- scan1blup(pr.full[,chr], gm.full$covar["ICI.vs.PBS"])
#  write.csv(as.data.frame(blup), paste0("data/ici.vs.pbs_blup.full_chr-",chr,"_5.batches_mis_conditional_2-peaks-chr3-10.csv"), quote=F)
#}

#save(out, operm, gm.full, gm, pr.qc, pr.full, file="data/ici.vs.pbs_scanone_5.batches_mis_conditional_2-peaks-chr3-10.Rdata")
...
write.csv(qtl.d3,"data/ici.vs.pbs_gm_qtl_5.batches_mis_conditional_2-peaks-chr3-10.csv", quote=F, row.names=F)
...
#  chr = i
#  blup <- scan1blup(pr.qc[,chr], gm$covar["ICI.vs.PBS"])
#  write.csv(as.data.frame(blup), paste0("data/ici.vs.pbs_blup.qc_chr-",chr,"_5.batches_mis_conditional_2-peaks-chr4-10.csv"), quote=F)
#}
...
#  chr = i
#  blup <- scan1blup(pr.full[,chr], gm.full$covar["ICI.vs.PBS"])
#  write.csv(as.data.frame(blup), paste0("data/ici.vs.pbs_blup.full_chr-",chr,"_5.batches_mis_conditional_2-peaks-chr4-10.csv"), quote=F)
#}

#save(out, operm, gm.full, gm, pr.qc, pr.full, file="data/ici.vs.pbs_scanone_5.batches_mis_conditional_2-peaks-chr4-10.Rdata")
...
write.csv(qtl.d3,"data/ici.vs.pbs_gm_qtl_5.batches_mis_conditional_2-peaks-chr4-10.csv", quote=F, row.names=F)
