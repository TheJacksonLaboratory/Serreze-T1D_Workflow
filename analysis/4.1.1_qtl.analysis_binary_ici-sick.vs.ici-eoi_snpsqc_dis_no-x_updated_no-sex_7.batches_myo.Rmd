...
# Plot 2
  ...
  write.csv(as.data.frame(blup_sub), paste0("data/ici-sick.vs.ici-eoi_blup_sub_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_snpsqc_dis_no-x_updated_no-sex_7.batches_myo.csv"), quote=F)
  ...
  write.csv(genesgss, file=paste0("data/ici-sick.vs.ici-eoi_genes_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_snpsqc_dis_no-x_updated_no-sex_7.batches_myo.csv"), quote=F)
...
#  write.csv(as.data.frame(blup), paste0("data/ici-sick.vs.ici-eoi_blup.qc_chr-",chr,"_snpsqc_dis_no-x_updated_no-sex_7.batches_myo.csv"), quote=F)
#}
...
#  write.csv(as.data.frame(blup), paste0("data/ici-sick.vs.ici-eoi_blup.full_chr-",chr,"_snpsqc_dis_no-x_updated_no-sex_7.batches_myo.csv"), quote=F)
#}

#save(out, operm, gm.full, gm, pr.qc, pr.full, file="data/ici-sick.vs.ici-eoi_scanone_snpsqc_dis_no-x_updated_no-sex_7.batches_myo.Rdata")
...
write.csv(qtl.d3,"data/ici-sick.vs.ici-eoi_gm_qtl_snpsqc_dis_no-x_updated_no-sex_7.batches_myo.csv", quote=F, row.names=F)
...
cross <- qtl::read.cross("csv", file = "data/ici-sick.vs.ici-eoi_gm_qtl_snpsqc_dis_no-x_updated_no-sex_7.batches_myo.csv",alleles=c("A","B"))
