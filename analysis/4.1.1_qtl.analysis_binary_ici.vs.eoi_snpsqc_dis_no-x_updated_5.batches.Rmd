...
covars <- read_csv("data/covar_corrected_ici.vs.eoi_5.batches.csv")
...
dismark <- read.csv("data/ici.vs.eoi_marker.freq_low.geno.freq.removed_geno.ratio_5.batches.csv")
nrow(dismark)
...
```{r QTL effects chr3, fig.height = 6, fig.width = 9.5, fig.align = "center", echo=TRUE, results="asis"}
...
# Plot 2
  ...
  write.csv(as.data.frame(blup_sub), paste0("data/ici.vs.eoi_blup_sub_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_snpsqc_dis_no-x_updated_5.batches.csv"), quote=F)
 ...
 # Plot 3
  ...
  write.csv(genesgss, file=paste0("data/ici.vs.eoi_genes_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_snpsqc_dis_no-x_updated_5.batches.csv"), quote=F)
...
```{r QTL effects chr4, fig.height = 6, fig.width = 9.5, fig.align = "center", echo=TRUE, results="asis"}
...
```{r QTL effects chr10, fig.height = 6, fig.width = 9.5, fig.align = "center", echo=TRUE, results="asis"}
...
#  write.csv(as.data.frame(blup), paste0("data/ici.vs.eoi_blup.qc_chr-",chr,"_snpsqc_dis_no-x_updated_5.batches.csv"), quote=F)
#}
...
#  write.csv(as.data.frame(blup), paste0("data/ici.vs.eoi_blup.full_chr-",chr,"_snpsqc_dis_no-x_updated_5.batches.csv"), quote=F)
#}
...
write.csv(qtl.d3,"data/ici.vs.eoi_gm_qtl_snpsqc_dis_no-x_updated_5.batches.csv", quote=F, row.names=F)
...
cross <- qtl::read.cross("csv", file = "data/ici.vs.eoi_gm_qtl_snpsqc_dis_no-x_updated_5.batches.csv",alleles=c("A","B"))
...
qc <- c(peaks$chr[1], peaks$chr[2], peaks$chr[3])
qp <- c(peaks$pos[1], peaks$pos[2], peaks$pos[3])
...
lod.add.1 <- qtl::fitqtl(fitqtl.d1, pheno.col="ICI.vs.EOI", qtl, formula=y~Q1+Q2+Q3,method="hk", model="binary", get.ests=FALSE)
print(summary(lod.add.1))

capture.output(summary(lod.add.1),file="data/ici.vs.eoi_fitqtl_peaks_additive_snpsqc_dis_no-x_updated_5.batches.txt", quote=F)

# fit model with 2 interacting QTLs interacting
lod.1 <- qtl::fitqtl(fitqtl.d1, pheno.col="ICI.vs.EOI", qtl, formula=y~Q1*Q2*Q3, method="hk", model="binary", get.ests=FALSE)
print(summary(lod.1))

capture.output(summary(lod.1),file="data/ici.vs.eoi_fitqtl_peaks_interacting_snpsqc_dis_no-x_updated_5.batches.txt", quote=F)
...
# additive model
lod.sex.add.1 <- qtl::fitqtl(fitqtl.d1, pheno.col="ICI.vs.EOI", qtl, formula=y~Q1+Q2+Q3+Sex, cov=Sex, method="hk", model="binary", get.ests=FALSE)
print(summary(lod.sex.add.1))

capture.output(summary(lod.sex.add.1),file="data/ici.vs.eoi_fitqtl_peaks_sex_additive_snpsqc_dis_no-x_updated_5.batches.txt", quote=F)

#interactive model

lod.sex.1 <- qtl::fitqtl(fitqtl.d1, pheno.col="ICI.vs.EOI", qtl, formula=y~Q1*Q2*Q3*Sex, cov=Sex, method="hk", model="binary", get.ests=FALSE)
print(summary(lod.sex.1))

capture.output(summary(lod.sex.1),file="data/ici.vs.eoi_fitqtl_peaks_sex_interacting_snpsqc_dis_no-x_updated_5.batches.txt", quote=F)
