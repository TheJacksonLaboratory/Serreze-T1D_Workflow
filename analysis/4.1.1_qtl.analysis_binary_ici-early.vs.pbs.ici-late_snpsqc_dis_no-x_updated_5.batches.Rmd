...
covars <- read_csv("data/covar_corrected_ici-early.vs.pbs.ici-late_5.batches.csv")
...
dismark <- read.csv("data/ici-early.vs.pbs.ici-late_marker.freq_low.geno.freq.removed_geno.ratio_5.batches.csv")
nrow(dismark)
...
# Plot 2
  ...
  write.csv(as.data.frame(blup_sub), paste0("data/ici-early.vs.pbs.ici-late_blup_sub_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_snpsqc_dis_no-x_updated_5.batches.csv"), quote=F)
 ...
 # Plot 3
  ...
  write.csv(genesgss, file=paste0("data/ici-early.vs.pbs.ici-late_genes_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_snpsqc_dis_no-x_updated_5.batches.csv"), quote=F)
...
for (i in names(pr.qc)){
  ...
  write.csv(as.data.frame(blup), paste0("data/ici-early.vs.pbs.ici-late_blup.qc_chr-",chr,"_snpsqc_dis_no-x_updated_5.batches.csv"), quote=F)
}
...
for (i in names(pr.full)){
  ...
  write.csv(as.data.frame(blup), paste0("data/ici-early.vs.pbs.ici-late_blup.full_chr-",chr,"_snpsqc_dis_no-x_updated_5.batches.csv"), quote=F)
}

save(out, operm, gm.full, gm, pr.qc, pr.full, file="data/ici-early.vs.pbs.ici-late_scanone_snpsqc_dis_no-x_updated_5.batches.Rdata")
...
write.csv(qtl.d3,"data/ici-early.vs.pbs.ici-late_gm_qtl_snpsqc_dis_no-x_updated_5.batches.csv", quote=F, row.names=F)
...
cross <- qtl::read.cross("csv", file = "data/ici-early.vs.pbs.ici-late_gm_qtl_snpsqc_dis_no-x_updated_5.batches.csv",alleles=c("A","B"))
