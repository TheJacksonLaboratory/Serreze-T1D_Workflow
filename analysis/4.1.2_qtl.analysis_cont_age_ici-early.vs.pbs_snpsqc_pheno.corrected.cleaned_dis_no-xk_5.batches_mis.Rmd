...
dismark <- read.csv("data/ici-early.vs.pbs_marker.freq_low.geno.freq.removed_sample.outliers.removed_geno.ratio_5.batches_mis.csv")
nrow(dismark)
...
print("with loco kinship")
outlk <- scan1(pr.qc, covars["age.of.onset"], Xcovar=Xcovar, model="normal", addcovar=addcovar, kinship=K)
...
print("with loco kinship")
outlk <- scan1(pr.qc, covars["age.of.onset"], Xcovar=Xcovar, model="normal", addcovar=addcovar, intcovar=addcovar, kinship=K)
