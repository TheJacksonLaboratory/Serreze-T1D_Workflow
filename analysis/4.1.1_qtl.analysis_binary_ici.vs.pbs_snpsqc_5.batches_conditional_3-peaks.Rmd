...
# Plot 2
  ...
  write.csv(as.data.frame(blup_sub), paste0("data/ici.vs.pbs_blup_sub_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_snpsqc_5.batches_conditional_3-peaks-chr3-4-10.csv"), quote=F)
 ...
 # Plot 3
  ...
  write.csv(genesgss, file=paste0("data/ici.vs.pbs_genes_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_snpsqc_5.batches_conditional_3-peaks-chr3-4-10.csv"), quote=F)
...
#  write.csv(as.data.frame(blup), paste0("data/ici.vs.pbs_blup.qc_chr-",chr,"_snpsqc_5.batches_conditional_3-peaks-chr3-4-10.csv"), quote=F)
#}
...
#  write.csv(as.data.frame(blup), paste0("data/ici.vs.pbs_blup.full_chr-",chr,"_snpsqc_5.batches_conditional_3-peaks-chr3-4-10.csv"), quote=F)
#}

#save(out, operm, gm.full, gm, pr.qc, pr.full, file="data/ici.vs.pbs_scanone_snpsqc_5.batches_conditional_3-peaks-chr3-4-10.Rdata")
...
write.csv(qtl.d3,"data/ici.vs.pbs_gm_qtl_snpsqc_5.batches_conditional_3-peaks-chr3-4-10.csv", quote=F, row.names=F)
...
cross <- qtl::read.cross("csv", file = "data/ici.vs.pbs_gm_qtl_snpsqc_5.batches_conditional_3-peaks-chr3-4-10.csv",alleles=c("A","B"))
