...
write.csv(gm$covar,"data/covar_corrected_ici-sick.vs.ici-eoi_4.batches_myo.csv", row.names=F, quote=F)
...
write.csv(gm$covar,"data/covar_corrected.cleaned_ici-sick.vs.ici-eoi_4.batches_myo.csv", row.names=F, quote=F)
...
##removing outliers
gm$covar$Mouse.ID <- rownames(gm$covar)
write.csv(gm$covar,"data/covar_corrected_ici.vs.pbs_4.batches_myo.csv", row.names=F, quote=F)
...
#gm$covar <- gm$covar[c(1:15)]
#gm$covar$id <- rownames(gm$covar)
write.csv(gm$covar,"data/covar_corrected.cleaned_ici.vs.pbs_4.batches_myo.csv", row.names=F, quote=F)
...
##removing outliers
gm$covar$Mouse.ID <- rownames(gm$covar)
write.csv(gm$covar,"data/covar_corrected_ici-myo-yes.vs.ici-myo-no_4.batches_myo.csv", row.names=F, quote=F)
...
#gm$covar <- gm$covar[c(1:15)]
#gm$covar$id <- rownames(gm$covar)
write.csv(gm$covar,"data/covar_corrected.cleaned_ici-myo-yes.vs.ici-myo-no_4.batches_myo.csv", row.names=F, quote=F)
...
##removing outliers
gm$covar$Mouse.ID <- rownames(gm$covar)
write.csv(gm$covar,"data/covar_corrected_pbs-myo-yes.vs.pbs-myo-no_4.batches_myo.csv", row.names=F, quote=F)
...
#gm$covar <- gm$covar[c(1:15)]
#gm$covar$id <- rownames(gm$covar)
write.csv(gm$covar,"data/covar_corrected.cleaned_pbs-myo-yes.vs.pbs-myo-no_4.batches_myo.csv", row.names=F, quote=F)
...
##removing outliers
gm$covar$Mouse.ID <- rownames(gm$covar)
write.csv(gm$covar,"data/covar_corrected_myo-yes.vs.myo-no_4.batches_myo.csv", row.names=F, quote=F)
...
#gm$covar <- gm$covar[c(1:15)]
#gm$covar$id <- rownames(gm$covar)
write.csv(gm$covar,"data/covar_corrected.cleaned_myo-yes.vs.myo-no_4.batches_myo.csv", row.names=F, quote=F)
...
##removing outliers
gm$covar$Mouse.ID <- rownames(gm$covar)
write.csv(gm$covar,"data/covar_corrected_het-ici.vs.het-pbs_4.batches_myo.csv", row.names=F, quote=F)
...
#gm$covar <- gm$covar[c(1:15)]
#gm$covar$id <- rownames(gm$covar)
write.csv(gm$covar,"data/covar_corrected.cleaned_het-ici.vs.het-pbs_4.batches_myo.csv", row.names=F, quote=F)
...
##removing outliers
gm$covar$Mouse.ID <- rownames(gm$covar)
write.csv(gm$covar,"data/covar_corrected_het-ici-myo-yes.vs.het-ici-myo-no_4.batches_myo.csv", row.names=F, quote=F)
...
#gm$covar <- gm$covar[c(1:15)]
#gm$covar$id <- rownames(gm$covar)
write.csv(gm$covar,"data/covar_corrected.cleaned_het-ici-myo-yes.vs.het-ici-myo-no_4.batches_myo.csv", row.names=F, quote=F)
