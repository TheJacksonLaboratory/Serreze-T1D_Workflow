...
#  write.csv(as.data.frame(blup), paste0("data/ici.vs.pbs_blup.qc_chr-",chr,"_snpsqc_dis_no-x_updated_5.batches_conditional_3-peaks-chr3-4-10.csv"), quote=F)
#}
...
#  write.csv(as.data.frame(blup), paste0("data/ici.vs.pbs_blup.full_chr-",chr,"_snpsqc_dis_no-x_updated_5.batches_conditional_3-peaks-chr3-4-10.csv"), quote=F)
#}

#save(out, operm, gm.full, gm, pr.qc, pr.full, file="data/ici.vs.pbs_scanone_snpsqc_dis_no-x_updated_5.batches_conditional_3-peaks-chr3-4-10.Rdata")
...
write.csv(qtl.d3,"data/ici.vs.pbs_gm_qtl_snpsqc_dis_no-x_updated_5.batches_conditional_3-peaks-chr3-4-10.csv", quote=F, row.names=F)
