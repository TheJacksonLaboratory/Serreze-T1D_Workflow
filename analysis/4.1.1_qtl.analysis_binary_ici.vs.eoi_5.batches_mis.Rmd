...
#  write.csv(as.data.frame(blup), paste0("data/ici.vs.eoi_blup.qc_chr-",chr,"_5.batches_mis.csv"), quote=F)
#}
...
#  write.csv(as.data.frame(blup), paste0("data/ici.vs.eoi_blup.full_chr-",chr,"_5.batches_mis.csv"), quote=F)
#}

#save(out, operm, gm.full, gm, pr.qc, pr.full, file="data/ici.vs.eoi_scanone_5.batches_mis.Rdata")
...
write.csv(qtl.d3,"data/ici.vs.eoi_gm_qtl_5.batches_mis.csv", quote=F, row.names=F)
