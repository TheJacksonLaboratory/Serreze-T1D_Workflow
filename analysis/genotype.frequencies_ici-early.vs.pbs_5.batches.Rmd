...
write.csv(filtered_gf_mar_geno, "data/ici-early.vs.pbs_marker.freq_low.geno.freq.removed_geno.ratio_5.batches.csv", quote=F)
write.csv(filtered_gf_mar_probs, "data/ici-early.vs.pbs_marker.freq_low.probs.freq.removed_geno.ratio_5.batches.csv", quote=F)
...
write.csv(filtered_gf_mar_geno, "data/ici-early.vs.pbs_marker.freq_low.geno.freq.removed_sample.outliers.removed_geno.ratiov_5.batches.csv", quote=F)
write.csv(filtered_gf_mar_probs, "data/ici-early.vs.pbs_marker.freq_low.probs.freq.removed_sample.outliers.removed_geno.ratio_5.batches.csv", quote=F)
