...
sample_inventory <- read.csv("/Users/corneb/Documents/MyJax/CS/Projects/Serreze/haplotype.reconstruction/output_5.batches/DODB_inventory_serreze_t1d_312_DO.csv", stringsAsFactors=FALSE, colClasses = c("character"))
hdf5_filename <- "/Users/corneb/Documents/MyJax/CS/Projects/Serreze/haplotype.reconstruction/output_5.batches/hdf5_serreze_t1d_312_DO.h5"
...
##physical map
write.csv(markers_2[,1:3], file = "data/physical_map_BC312.csv",row.names = FALSE, quote = FALSE)


##genetic map
write.csv(markers_2[,c(1,2,4)], file = "data/genetic_map_BC312.csv",row.names = FALSE, col.names =c("marker", "chr", "pos"), quote = FALSE)  
...
write.csv(sample.geno.2, file = "data/sample_geno_AHB_BC312.csv",row.names = F, quote = F)

sample.geno.1 <- data.frame(marker = marker.names, geno.1[marker.names,], stringsAsFactors = F, check.names=F)
write.csv(sample.geno.1, file = "data/sample_geno_bc_BC312.csv",row.names = F, quote = F)
...
write.csv(covar, file <- "data/GM_covar_BC312.csv", quote = FALSE)
...
write.csv(pheno, file <- "data/pheno_BC312.csv", row.names = TRUE, quote = FALSE)
...
saveRDS(probsA, file = "data/serreze_probs_BC312.rds")


e <- calc_errorlod(gm, probsA, cores=20)
e <- do.call("cbind", e)
save(e, file = "data/e_BC312.RData")
```