---
title: "QTL Analysis - age of onset [ICI vs EOI] (corrected phenotype, sample outliers & disproportionate markers removed)"
...
dismark <- read.csv("data/ici.vs.eoi_marker.freq_low.geno.freq.removed_sample.outliers.removed_geno.ratio.csv")
nrow(dismark)
...
peaks<-find_peaks(out, gm$gmap, threshold=1.0, drop=1.5)
