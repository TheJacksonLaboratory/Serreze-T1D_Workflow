...
```{r QTL effects chr3, echo=TRUE, results="asis"}
...
```{r QTL effects chr4, echo=TRUE, results="asis"}
...
# additive model
lod.sex.add.1 <- qtl::fitqtl(fitqtl.d1, pheno.col="ICI.vs.EOI", qtl, formula=y~Q1+Q2+Sex, cov=Sex, method="hk", model="binary", get.ests=FALSE)
print(summary(lod.sex.add.1))

#interactive model

lod.sex.1 <- qtl::fitqtl(fitqtl.d1, pheno.col="ICI.vs.EOI", qtl, formula=y~Q1*Q2*Sex, cov=Sex, method="hk", model="binary", get.ests=FALSE)
