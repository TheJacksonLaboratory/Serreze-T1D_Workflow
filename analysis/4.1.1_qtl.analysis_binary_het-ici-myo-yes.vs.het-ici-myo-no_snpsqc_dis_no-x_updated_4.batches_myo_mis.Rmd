...
dismark <- read.csv("data/het-ici-myo-yes.vs.het-ici-myo-no_marker.freq_low.geno.freq.removed_geno.ratio_4.batches_myo_mis.csv")
nrow(dismark)
...
# Plot 2
  ...
  write.csv(as.data.frame(blup_sub), paste0("data/het-ici-myo-yes.vs.het-ici-myo-no_blup_sub_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_snpsqc_dis_no-x_updated_4.batches_myo_mis.csv"), quote=F)
  ...
  write.csv(genesgss, file=paste0("data/het-ici-myo-yes.vs.het-ici-myo-no_genes_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_snpsqc_dis_no-x_updated_4.batches_myo_mis.csv"), quote=F)
...
#  write.csv(as.data.frame(blup), paste0("data/het-ici-myo-yes.vs.het-ici-myo-no_blup.qc_chr-",chr,"_snpsqc_dis_no-x_updated_4.batches_myo_mis.csv"), quote=F)
#}
...
#  write.csv(as.data.frame(blup), paste0("data/het-ici-myo-yes.vs.het-ici-myo-no_blup.full_chr-",chr,"_snpsqc_dis_no-x_updated_4.batches_myo_mis.csv"), quote=F)
#}

#save(out, operm, gm.full, gm, pr.qc, pr.full, file="data/het-ici-myo-yes.vs.het-ici-myo-no_scanone_snpsqc_dis_no-x_updated_4.batches_myo_mis.Rdata")
...
write.csv(qtl.d3,"data/het-ici-myo-yes.vs.het-ici-myo-no_gm_qtl_snpsqc_dis_no-x_updated_4.batches_myo_mis.csv", quote=F, row.names=F)
...
cross <- qtl::read.cross("csv", file = "data/het-ici-myo-yes.vs.het-ici-myo-no_gm_qtl_snpsqc_dis_no-x_updated_4.batches_myo_mis.csv",alleles=c("A","B"))
