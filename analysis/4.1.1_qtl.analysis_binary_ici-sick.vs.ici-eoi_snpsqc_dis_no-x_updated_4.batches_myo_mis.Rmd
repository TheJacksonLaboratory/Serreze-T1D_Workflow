...
setwd("/projects/serreze-lab/USERS/corneb/qtl2/workflowr/Serreze-T1D_Workflow")
...
covars <- read_csv("data/covar_corrected_ici-sick.vs.ici-eoi_4.batches_myo_mis.csv")
...
dismark <- read.csv("data/ici-sick.vs.ici-eoi_marker.freq_low.geno.freq.removed_geno.ratio_4.batches_myo_mis.csv")
nrow(dismark)
...
operm <- scan1perm(pr.qc, covars["ici.sick_vs_ici.eoi"], model="binary", addcovar=addcovar, n_perm=1000)
...
# Plot 2
  ...
  write.csv(as.data.frame(blup_sub), paste0("data/ici-sick.vs.ici-eoi_blup_sub_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_snpsqc_dis_no-x_updated_4.batches_myo_mis.csv"), quote=F)
  ...
  write.csv(genesgss, file=paste0("data/ici-sick.vs.ici-eoi_genes_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_snpsqc_dis_no-x_updated_4.batches_myo_mis.csv"), quote=F)
...
#  write.csv(as.data.frame(blup), paste0("data/ici-sick.vs.ici-eoi_blup.qc_chr-",chr,"_snpsqc_dis_no-x_updated_4.batches_myo_mis.csv"), quote=F)
#}
...
#  write.csv(as.data.frame(blup), paste0("data/ici-sick.vs.ici-eoi_blup.full_chr-",chr,"_snpsqc_dis_no-x_updated_4.batches_myo_mis.csv"), quote=F)
#}

#save(out, operm, gm.full, gm, pr.qc, pr.full, file="data/ici-sick.vs.ici-eoi_scanone_snpsqc_dis_no-x_updated_4.batches_myo_mis.Rdata")
...
genos <- read.csv("data/sample_geno_bc_4.batches_myo_BC217.csv")
...
write.csv(qtl.d3,"data/ici-sick.vs.ici-eoi_gm_qtl_snpsqc_dis_no-x_updated_4.batches_myo_mis.csv", quote=F, row.names=F)
...
cross <- qtl::read.cross("csv", file = "data/ici-sick.vs.ici-eoi_gm_qtl_snpsqc_dis_no-x_updated_4.batches_myo_mis.csv",alleles=c("A","B"))
...
addcovar <- pull.pheno(cross, c("sex","age.of.onset","Histology.Score"))
