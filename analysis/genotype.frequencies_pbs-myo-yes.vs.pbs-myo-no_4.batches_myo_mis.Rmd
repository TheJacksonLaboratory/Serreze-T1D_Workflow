---
title: "Genotype Frequencies - PBS Myocarditis Yes vs PBS Myocarditis No"
...
## saving files
write.csv(filtered_gf_mar_geno_sample, "data/pbs-myo-yes.vs.pbs-myo-no_sample.genos_marker.freq_low.geno.freq.removed_4.batches_myo_mis.csv", quote=F)
write.csv(filtered_gf_mar_probs_sample, "data/pbs-myo-yes.vs.pbs-myo-no_sample.genos_marker.freq_low.probs.freq.removed_4.batches_myo_mis.csv", quote=F)

write.csv(filtered_gf_mar_geno, "data/pbs-myo-yes.vs.pbs-myo-no_marker.freq_low.geno.freq.removed_geno.ratio_4.batches_myo_mis.csv", quote=F)
write.csv(filtered_gf_mar_probs, "data/pbs-myo-yes.vs.pbs-myo-no_marker.freq_low.probs.freq.removed_geno.ratio_4.batches_myo_mis.csv", quote=F)
...
covars <- read_csv("data/covar_corrected.cleaned_pbs-myo-yes.vs.pbs-myo-no_4.batches_myo_mis.csv")
# removing any missing info
...
## saving files
write.csv(filtered_gf_mar_geno_sample, "data/pbs-myo-yes.vs.pbs-myo-no_sample.genos_marker.freq_low.geno.freq.removed_sample.outliers.removed_4.batches_myo_mis.csv", quote=F)
write.csv(filtered_gf_mar_probs_sample, "data/pbs-myo-yes.vs.pbs-myo-no_sample.genos_marker.freq_low.probs.freq.removed_sample.outliers.removed_4.batches_myo_mis.csv", quote=F)

write.csv(filtered_gf_mar_geno, "data/pbs-myo-yes.vs.pbs-myo-no_marker.freq_low.geno.freq.removed_sample.outliers.removed_geno.ratio_4.batches_myo_mis.csv", quote=F)
write.csv(filtered_gf_mar_probs, "data/pbs-myo-yes.vs.pbs-myo-no_marker.freq_low.probs.freq.removed_sample.outliers.removed_geno.ratio_4.batches_myo_mis.csv", quote=F)
