...
covars <- read_csv("data/covar_corrected_ici.vs.eoi_5.batches_mis_0.csv")
...
## saving files
#write.csv(filtered_gf_mar_geno_sample, "data/ici.vs.eoi_sample.genos_marker.freq_low.geno.freq.removed_0.csv", quote=F)
#write.csv(filtered_gf_mar_probs_sample, "data/ici.vs.eoi_sample.genos_marker.freq_low.probs.freq.removed_0.csv", quote=F)

write.csv(filtered_gf_mar_geno, "data/ici.vs.eoi_marker.freq_low.geno.freq.removed_geno.ratio_5.batches_mis_0.csv", quote=F)
write.csv(filtered_gf_mar_probs, "data/ici.vs.eoi_marker.freq_low.probs.freq.removed_geno.ratio_5.batches_mis_0.csv", quote=F)
...
## saving files
#write.csv(filtered_gf_mar_geno_sample, "data/ici.vs.eoi_sample.genos_marker.freq_low.geno.freq.removed_sample.outliers.removed_0.csv", quote=F)
#write.csv(filtered_gf_mar_probs_sample, "data/ici.vs.eoi_sample.genos_marker.freq_low.probs.freq.removed_sample.outliers.removed_0.csv", quote=F)

write.csv(filtered_gf_mar_geno, "data/ici.vs.eoi_marker.freq_low.geno.freq.removed_sample.outliers.removed_geno.ratio_5.batches_mis_0.csv", quote=F)
write.csv(filtered_gf_mar_probs, "data/ici.vs.eoi_marker.freq_low.probs.freq.removed_sample.outliers.removed_geno.ratio_5.batches_mis_0.csv", quote=F)
