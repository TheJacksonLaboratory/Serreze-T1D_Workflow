...
# Plot 2
  ...
  write.csv(as.data.frame(blup_sub), paste0("data/ici-myo-yes.vs.ici-myo-no_blup_sub_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_snpsqc_7.batches_myo.csv"), quote=F)
  ...
  write.csv(genesgss, file=paste0("data/ici-myo-yes.vs.ici-myo-no_genes_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_snpsqc_7.batches_myo.csv"), quote=F)
...
#  write.csv(as.data.frame(blup), paste0("data/ici-myo-yes.vs.ici-myo-no_blup.qc_chr-",chr,"_snpsqc_7.batches_myo.csv"), quote=F)
#}
...
#  write.csv(as.data.frame(blup), paste0("data/ici-myo-yes.vs.ici-myo-no_blup.full_chr-",chr,"_snpsqc_7.batches_myo.csv"), quote=F)
#}

#save(out, operm, gm.full, gm, pr.qc, pr.full, file="data/ici-myo-yes.vs.ici-myo-no_scanone_snpsqc_7.batches_myo.Rdata")
...
write.csv(qtl.d3,"data/ici-myo-yes.vs.ici-myo-no_gm_qtl_snpsqc_7.batches_myo.csv", quote=F, row.names=F)
...
cross <- qtl::read.cross("csv", file = "data/ici-myo-yes.vs.ici-myo-no_gm_qtl_snpsqc_7.batches_myo.csv",alleles=c("A","B"))
