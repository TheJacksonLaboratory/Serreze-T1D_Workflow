...
# Plot 2
  ...
  write.csv(as.data.frame(blup_sub), paste0("data/ici.vs.eoi_blup_sub_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_snpsqc_5.batches.csv"), quote=F)
 ...
 # Plot 3
  ...
  write.csv(genesgss, file=paste0("data/ici.vs.eoi_genes_chr-",chr,"_peak.marker-",peaks$marker[i],"_lod.drop-1.5_snpsqc_5.batches.csv"), quote=F)
...
#  write.csv(as.data.frame(blup), paste0("data/ici.vs.eoi_blup.qc_chr-",chr,"_snpsqc_5.batches.csv"), quote=F)
#}
...
#  write.csv(as.data.frame(blup), paste0("data/ici.vs.eoi_blup.full_chr-",chr,"_snpsqc_5.batches.csv"), quote=F)
#}

#save(out, operm, gm.full, gm, pr.qc, pr.full, file="data/ici.vs.eoi_scanone_snpsqc_5.batches.Rdata")
...
write.csv(qtl.d3,"data/ici.vs.eoi_gm_qtl_snpsqc_5.batches.csv", quote=F, row.names=F)
...
cross <- qtl::read.cross("csv", file = "data/ici.vs.eoi_gm_qtl_snpsqc_5.batches.csv",alleles=c("A","B"))
...
capture.output(summary(lod.add.1),file="data/ici.vs.eoi_fitqtl_peaks_additive_snpsqc_5.batches.txt", quote=F)
...
capture.output(summary(lod.1),file="data/ici.vs.eoi_fitqtl_peaks_interacting_snpsqc_5.batches.txt", quote=F)
...
capture.output(summary(lod.sex.add.1),file="data/ici.vs.eoi_fitqtl_peaks_sex_additive_snpsqc_5.batches.txt", quote=F)
...
capture.output(summary(lod.sex.1),file="data/ici.vs.eoi_fitqtl_peaks_sex_interacting_snpsqc_5.batches.txt", quote=F)
