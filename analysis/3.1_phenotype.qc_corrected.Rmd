...
write.csv(gm$covar,"data/covar_corrected_ici.vs.eoi.csv", row.names=F, quote=F)
...
write.csv(gm$covar,"data/covar_corrected.cleaned_ici.vs.eoi.csv", row.names=F, quote=F)
...
##removing outliers
gm$covar$Mouse.ID <- rownames(gm$covar)
write.csv(gm$covar,"data/covar_corrected_ici.vs.pbs.csv", row.names=F, quote=F)
...
#gm$covar <- gm$covar[c(1:15)]
#gm$covar$id <- rownames(gm$covar)
write.csv(gm$covar,"data/covar_corrected.cleaned_ici.vs.pbs.csv", row.names=F, quote=F)
