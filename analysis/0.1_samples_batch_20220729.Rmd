---
title: "Samples [Batch: MURGIGV01_20220729]"
...
filepathg = '/Users/corneb/Documents/MyJax/CS/Projects/Serreze/Neogen/2022.11.22/Jackson_Lab_Serreze/The_Jackson_Lab_Serreze_MURGIGV01_20220729/'
filepaths = '//Users/corneb/Documents/MyJax/CS/Projects/Serreze/haplotype.reconstruction/output_4.batches_myo_corrected/'
filepathp = '/Users/corneb/Documents/MyJax/CS/Projects/Serreze/haplotype.reconstruction/output_4.batches_myo_corrected/qtl2/'
...
pheno_file <- dir(path = filepathp, pattern = "GM_covar_pheno_myo_corrected_v6.csv", full.names = TRUE)
...
sexprobs = which(substring(summary$Provided.Sex, 1, 1) != summary$Inferred.Sex)
...
summary[summary$Myocarditis.Status == "NO",]$age.of.clinical.phenotype..weeks. <- '--'
phenoprobs = which(is.na(summary$age.of.clinical.phenotype..weeks))
...
summary[c(1:17,31)] %>%
  ...
  row_spec(crprobs ,color= "white",background = "red") 
```
...
summary[c(1,22,23)] %>%
  ...
  row_spec(sexprobs ,color= "white",background = "blue") 

# 3 16 21 22 26 28 38 39 45
...
summary[c(1,35:38)] %>%
  ...
  kable_styling("striped", full_width = F) %>%
  column_spec(1:3, width = "3cm") %>%
  row_spec(phenoprobs ,color= "white",background = "green")
...
dis$no_pheno <- ifelse(is.na(summary$age.of.clinical.phenotype..weeks), 'XX', '')
