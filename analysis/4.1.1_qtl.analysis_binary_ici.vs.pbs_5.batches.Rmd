...
#  write.csv(as.data.frame(blup), paste0("data/ici.vs.pbs_blup.qc_chr-",chr,"_5.batches.csv"), quote=F)
#}
...
#  write.csv(as.data.frame(blup), paste0("data/ici.vs.pbs_blup.full_chr-",chr,"_5.batches.csv"), quote=F)
#}

#save(out, operm, gm.full, gm, pr.qc, pr.full, file="data/ici.vs.pbs_scanone_5.batches.Rdata")
...
write.csv(qtl.d3,"data/ici.vs.pbs_gm_qtl_5.batches.csv", quote=F, row.names=F)
