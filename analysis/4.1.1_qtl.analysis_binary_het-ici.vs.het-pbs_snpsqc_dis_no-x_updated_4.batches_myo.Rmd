...
#  write.csv(as.data.frame(blup), paste0("data/het-ici.vs.het-pbs_blup.qc_chr-",chr,"_snpsqc_dis_no-x_updated_4.batches_myo.csv"), quote=F)
#}
...
#  write.csv(as.data.frame(blup), paste0("data/het-ici.vs.het-pbs_blup.full_chr-",chr,"_snpsqc_dis_no-x_updated_4.batches_myo.csv"), quote=F)
#}

#save(out, operm, gm.full, gm, pr.qc, pr.full, file="data/het-ici.vs.het-pbs_scanone_snpsqc_dis_no-x_updated_4.batches_myo.Rdata")
...
write.csv(qtl.d3,"data/het-ici.vs.het-pbs_gm_qtl_snpsqc_dis_no-x_updated_4.batches_myo.csv", quote=F, row.names=F)
...
cross <- qtl::read.cross("csv", file = "data/het-ici.vs.het-pbs_gm_qtl_snpsqc_dis_no-x_updated_4.batches_myo.csv",alleles=c("A","B"))
