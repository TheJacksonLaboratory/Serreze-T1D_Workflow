...
write.csv(gm$covar,"data/covar_corrected_ici-early.vs.pbs.ici-late_5.batches.csv", row.names=F, quote=F)
...
write.csv(gm$covar,"data/covar_corrected.cleaned_ici-early.vs.pbs.ici-late_5.batches.csv", row.names=F, quote=F)
