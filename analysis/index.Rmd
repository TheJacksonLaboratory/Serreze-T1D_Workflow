...
* continious phenotype
  + ICI vs EOI
    + age-of-onset
      ...
      + Missing & Low Frequency markers removed
        + [Original Information](4.1.2_qtl.analysis_cont_age_ici.vs.eoi_snpsqc.html)
    ...
    + ranknorm age-of-onset
      ...
      + Missing & Low Frequency markers removed
        + [Original Information & Outliers Removed](4.1.2_qtl.analysis_cont_rzage_ici.vs.eoi_snpsqc.html)
  ...
  + ICI vs PBS
    + age-of-onset
      ...
      + Missing & Low Frequency markers removed
        + [Original Information](4.1.2_qtl.analysis_cont_age_ici.vs.pbs_snpsqc.html)
    ...
    + ranknorm age-of-onset
      ...
      + Missing & Low Frequency markers removed
        + [Original Information & Outliers Removed](4.1.2_qtl.analysis_cont_rzage_ici.vs.pbs_snpsqc.html)
