...
design[1,8] <- paste0("sex [F: ", nrow(gm$covar[gm$covar$sex=="Female",]), "; M: ", nrow(gm$covar[gm$covar$sex=="Male",]),"]")
...
### **4. QTL Analysis**
* binary phenotpe
  + [ICI vs EOI](4.1.1_qtl.analysis_binary_ici.vs.eoi.html)
  + [ICI vs PBS](4.1.1_qtl.analysis_binary_ici.vs.pbs.html)
* continious phenotype
  + ICI vs EOI
    + [age-of-onset](4.1.2_qtl.analysis_cont_age_ici.vs.eoi.html)
    + [ranknorm age-of-onset](4.1.2_qtl.analysis_cont_rzage_ici.vs.eoi.html)
  + ICI vs PBS
    + [age-of-onset](4.1.2_qtl.analysis_cont_age_ici.vs.pbs.html)
    + [ranknorm age-of-onset](4.1.2_qtl.analysis_cont_rzage_ici.vs.pbs.html)
