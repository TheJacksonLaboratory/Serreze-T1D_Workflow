...
### **Haplotype Phasing**
* [Figures](0.2_haplotype_comparison_bqc_4batches.html)
...
design[1,8] <- paste0("sex [F: ", nrow(gm$covar[gm$covar$sex=="Female",]), "; M: ", nrow(gm$covar[gm$covar$sex=="Male",]),"] (not uses as all females; binary diabetic status for continous traits")
...
### **3. Phenotype QC**
* Phenotypes
  + [continuous](3.1_phenotype.qc.html)

### **4. QTL Analysis**
* binary phenotpe
  + ICI vs EOI
    + [All markers](4.1.1_qtl.analysis_binary_ici.vs.eoi.html)
    + [Missing & Monomorphic markers removed](4.1.1_qtl.analysis_binary_ici.vs.eoi_snpsqc.html)
  + ICI vs PBS
    + [All markers](4.1.1_qtl.analysis_binary_ici.vs.pbs.html)
    + [Missing & Monomorphic markers removed](4.1.1_qtl.analysis_binary_ici.vs.pbs_snpsqc.html)
* continious phenotype
  + ICI vs EOI
    + age-of-onset
      + [All markers](4.1.2_qtl.analysis_cont_age_ici.vs.eoi.html)
      + [Missing & Monomorphic markers removed](4.1.2_qtl.analysis_cont_age_ici.vs.eoi_snpsqc.html)
    + ranknorm age-of-onset
      + [All markers](4.1.2_qtl.analysis_cont_rzage_ici.vs.eoi.html)
      + [Missing & Monomorphic markers removed](4.1.2_qtl.analysis_cont_rzage_ici.vs.eoi_snpsqc.html)
  + ICI vs PBS
    + age-of-onset
      + [All markers](4.1.2_qtl.analysis_cont_age_ici.vs.pbs.html)
      + [Missing & Monomorphic markers removed](4.1.2_qtl.analysis_cont_age_ici.vs.pbs_snpsqc.html)
    + ranknorm age-of-onset
      + [All markers](4.1.2_qtl.analysis_cont_rzage_ici.vs.pbs.html)
      + [Missing & Monomorphic markers removed](4.1.2_qtl.analysis_cont_rzage_ici.vs.pbs_snpsqc.html)
