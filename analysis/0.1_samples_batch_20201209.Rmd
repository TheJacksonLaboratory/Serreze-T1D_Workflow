---
title: "Samples [Batch: MURGIGV01_20201209]"
...
filepathg = '/Users/corneb/Documents/MyJax/CS/Projects/Serreze/Neogen/The_Jackson_Lab_Serreze_MURGIGV01_20201209'
...
summary[c(1:17,31)] %>%
  ...
  row_spec(20,color= "white",background = "red") %>%
  row_spec(24,color= "white",background = "red") 
...
summary[c(1,22,23)] %>%
  ...
  row_spec(1 ,color= "white",background = "blue")  %>%
  row_spec(2 ,color= "white",background = "blue")  %>%
  row_spec(3 ,color= "white",background = "blue")  %>%
  row_spec(4 ,color= "white",background = "blue")  %>%
  row_spec(5 ,color= "white",background = "blue")  %>%
  row_spec(6 ,color= "white",background = "blue")  %>%
  row_spec(7 ,color= "white",background = "blue")  %>%
  row_spec(8 ,color= "white",background = "blue")  %>%
  row_spec(9 ,color= "white",background = "blue")  %>%
  row_spec(13 ,color= "white",background = "blue")  %>%
  row_spec(14 ,color= "white",background = "blue")  %>%
  row_spec(15 ,color= "white",background = "blue")  %>%
  row_spec(16 ,color= "white",background = "blue")  %>%
  row_spec(17 ,color= "white",background = "blue")  %>%
  row_spec(18 ,color= "white",background = "blue") 
