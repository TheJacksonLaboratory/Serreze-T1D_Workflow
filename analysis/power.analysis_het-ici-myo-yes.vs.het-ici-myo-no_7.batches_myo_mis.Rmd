---
title: "Power Analysis - Hetero: ICI Myocarditis Yes vs ICI Myocarditis No"
...
gm$covar$group = gm$covar$het.ici.myo.yes_vs_het.ici.myo.no


##loading genotypes

genos.1 <- read.csv("data/het-ici-myo-yes.vs.het-ici-myo-no_sample.genos_marker.freq_low.geno.freq.removed_7.batches_myo_mis.csv")
dim(genos.1)
genos.1 <- genos.1[genos.1$Include,]
dim(genos.1)
#dis.genos.1 <- read.csv("data/het-ici-myo-yes.vs.het-ici-myo-no_marker.freq_low.geno.freq.removed_geno.ratio_7.batches_myo_mis_mis.csv")
#dim(dis.genos.1)
rownames(genos.1) <- genos.1$marker
genos.1 <- t(genos.1[3:(ncol(genos.1)-9)])
rownames(genos.1) <- gsub("\\.","-",rownames(genos.1))

genos.2<- read.csv("data/het-ici-myo-yes.vs.het-ici-myo-no_sample.genos_marker.freq_low.geno.freq.removed_sample.outliers.removed_7.batches_myo_mis.csv")
dim(genos.2)
genos.2 <- genos.2[genos.2$Include,]
dim(genos.2)
#dis.genos.2 <- read.csv("data/het-ici-myo-yes.vs.het-ici-myo-no_marker.freq_low.geno.freq.removed_sample.outliers.removed_geno.ratio_7.batches_myo_mis_mis.csv")
...
write.csv(age.marker.sum.1.all.t,"data/mean.differences_age.of.onset_het-ici-myo-yes.vs.het-ici-myo-no_sample.genos_marker.freq_low.geno.freq.removed_7.batches_myo_mis.csv")
...
write.csv(age.marker.sum.2.all.t,"data/mean.differences_age.of.onset_het-ici-myo-yes.vs.het-ici-myo-no_sample.genos_marker.freq_low.geno.freq.removed_sample.outliers.removed_7.batches_myo_mis.csv")
...
age.marker.sum.1.all.t <- as.data.frame(age.marker.sum.1.all.t)
age.marker.sum.1.all.t$diffhethom <- age.marker.sum.1.all.t$AB - age.marker.sum.1.all.t$AA
write.csv(age.marker.sum.1.all.t,"data/mean.differences_group_het-ici-myo-yes.vs.het-ici-myo-no_sample.genos_marker.freq_low.geno.freq.removed_7.batches_myo_mis.csv")
...
age.marker.sum.2.all.t <- as.data.frame(age.marker.sum.2.all.t)
age.marker.sum.2.all.t$diffhethom <- age.marker.sum.2.all.t$AB - age.marker.sum.2.all.t$AA
write.csv(age.marker.sum.2.all.t,"data/mean.differences_group_het-ici-myo-yes.vs.het-ici-myo-no_sample.genos_marker.freq_low.geno.freq.removed_sample.outliers.removed_7.batches_myo_mis.csv")
